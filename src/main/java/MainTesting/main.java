...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = "C:\\Users\\Jutsu\\Downloads\\WoWCombatLog (2).txt";
        ...
        o.addProperty("0", "6/3 15:47:02.043  SPELL_AURA_APPLIED,Player-4467-00526CA0,\"Inspire-Firemaw\",0x518,0x0,Player-4467-00526CA0,\"Inspire-Firemaw\",0x518,0x0,14322,\"Aspect of the Hawk\",0x8,BUFF");
        try {


            //FileReaderFromBase64(new EventHandler(), data);
            AnalysisHandler ah = new AnalysisHandler("Maloni-Mograine", path);
            

            JsonArray data = new JsonArray();
            data.add(o);
            //FileReaderFromBase64(new EventHandler(), data);
            AnalysisHandler ah = new AnalysisHandler("Drillenissen-firemaw", data);
            /*
             ...
             */
            /**
             * long t0 = (long)0; Event e0 = new Duel(); Date d = new Date();
             * d.setTime(100); e0.setDate(d);
             *
             * Event e1 = new Duel(); Date d1 = new Date(); d1.setTime(200);
             * e1.setDate(d1);
             *
             * Event e11= new Duel(); e11.setDate(d1);
             *
             * Event e2 = new Duel(); Date d2 = new Date(); d2.setTime(300);
             * e2.setDate(d1);
             *
             * Event e3 = new Duel(); e3.setDate(d2);
             *
             * Event e4 = new Duel(); e4.setDate(d2);
             *
             * Event[] arr = {e0,e1,e11,e2,e3,e4}; List<Event> l=
             * Arrays.asList(arr);
             */
        } catch (Exception ex) {
